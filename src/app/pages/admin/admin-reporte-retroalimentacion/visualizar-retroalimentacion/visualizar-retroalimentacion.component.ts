...
@Component({
  selector: 'app-visualizar-retroalimentacion',
  templateUrl: './visualizar-retroalimentacion.component.html',
  styleUrls: ['./visualizar-retroalimentacion.component.css']
})
export class VisualizarRetroalimentacionComponent implements OnInit {
