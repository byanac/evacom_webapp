...
@Component({
  selector: 'app-ver-excepcion-resultado-retroalimentacion',
  templateUrl: './ver-excepcion-resultado-retroalimentacion.component.html',
  styleUrls: ['./ver-excepcion-resultado-retroalimentacion.component.css']
})
export class VerExcepcionResultadoRetroalimentacionComponent implements OnInit {
  ...
  EvaluadorCodigoFicha: string = this.route.snapshot.paramMap.get('EvaluadorCodigoFicha');
  EvaluadorCodigoPuesto: string = this.route.snapshot.paramMap.get('EvaluadorCodigoPuesto');
  CodCalendario: string = this.route.snapshot.paramMap.get('CodCalendario');
  NombreCalendario: string = this.route.snapshot.paramMap.get('NombreCalendario');
