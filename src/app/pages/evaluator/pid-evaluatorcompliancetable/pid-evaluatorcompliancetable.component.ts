...
@Component({
  selector: 'app-pid-evaluatorcompliancetable',
  templateUrl: './pid-evaluatorcompliancetable.component.html',
  styleUrls: ['./pid-evaluatorcompliancetable.component.css']
})
export class PidEvaluatorcompliancetableComponent implements OnInit {
  ...
  async FilterData(){
    if(this.Periodo === ""){
      ...
      this.utilsService.showLoading();
      //console.log(this.SesionData.codPuesto)
