...
export const EvaluatorEvaluationItems: SubMenu[] = [
    {
      SubMenuName: 'Fase de Evaluación',
      startCalendarName: 'dEvalIni',
      endCalendarName: 'dEvalFin',
      exceptionFlagName: 'habilitadoEvaluacion',
      SubMenuItems: [
        {
          name: 'Evaluación 180°',
          route: 'registrar-evaluacion/180',
          type: '180',
