...
export const environment = {
    ...
    //INI PROY-00013 RFC
    getMembersTeam: `${starturlSedapal}/api/directorio/equipos/listar180`,
    GetUnidadOrganizativa :`${starturlSedapal}/api/grupoEvaluacion/listarUnidadOrganizativa`,
    GetMemberByTeam: `${starturlSedapal}/api/directorio/equipos/listar180ByTeam`,
    UpdateDirectorioFicha:`${starturlSedapal}/api/directorio/compara`,
    UpdateGerencyAPI:`${starturlSedapal}/api/util/update/gerencias`, 
    UpdateTeamAPI:`${starturlSedapal}/api/util/update/equipos`,
    //FIN PROY-00013 RFC
    ...
    PostPutCargaAutomaticaAsignationGroupsReport: `${starturlSedapal}/api/grupoEvaluacionAsignacion/cargaAutomaticaGrupoEvaluacionAsignacion`, //INI PROY-00013 RFC
    validarDataCargaAutomaticaEvalsGroups: `${starturlSedapal}/api/grupoEvaluacionAsignacion/validarCargaAutomaticaGrupoEvaluacionAsignacion`, //INI PROY-00013 RFC
    ...
    PostPutCargaAutomaticaEvalAsignationReport: `${starturlSedapal}/api/evaluacionAsignacion/cargaAutomaticaEvaluacionAsignacion`, //INI PROY-00013 RFC
    validarDataCargaAutomaticaEvalAsignationReport: `${starturlSedapal}/api/evaluacionAsignacion/validarCargaAutomaticaEvaluacionAsignacion`, //INI PROY-00013 RFC
